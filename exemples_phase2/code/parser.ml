...
let rec _menhir_goto_expression : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.program) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState39 ->
        ...
        | END ->
            ...
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((_menhir_stack, _menhir_s), _, (expr : (Ast.program))) = _menhir_stack in
            let _3 = () in
            let _1 = () in
            let _v : (Ast.program) = 
# 37 "parser.mly"
...
# 90 "parser.ml"
    ...
    | MenhirState27 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (_menhir_stack, _, (expr : (Ast.program))) = _menhir_stack in
        let _2 = () in
        let _1 = () in
        let _v : (Ast.program) = 
# 30 "parser.mly"
...
# 117 "parser.ml"
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, (a : (Ast.automate))) = _menhir_stack in
            let _2 = () in
            let _v : (
# 9 "parser.mly"
      (Ast.automate)
...
and _menhir_goto_casetop : _menhir_env -> 'ttv_tail -> _menhir_state -> ((char * Ast.program) list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState43 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (case : ((char * Ast.program) list)) = _v in
        let ((_menhir_stack, _menhir_s, (l : (
# 6 "parser.mly"
       (char)
# 164 "parser.ml"
        ))), _, (instr : (Ast.program))) = _menhir_stack in
        let _2 = () in
...
# 170 "parser.ml"
         in
        _menhir_goto_casetop _menhir_env _menhir_stack _menhir_s _v
    | MenhirState36 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (case : ((char * Ast.program) list)) = _v in
...
and _menhir_goto_casestate : _menhir_env -> 'ttv_tail -> _menhir_state -> ((char * Ast.program) list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState50 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 206 "parser.ml"
         in
        _menhir_goto_casestate _menhir_env _menhir_stack _menhir_s _v
    | MenhirState47 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (case : ((char * Ast.program) list)) = _v in
...
and _menhir_goto_casenext : _menhir_env -> 'ttv_tail -> _menhir_state -> ((char * Ast.program) list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState57 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 242 "parser.ml"
         in
        _menhir_goto_casenext _menhir_env _menhir_stack _menhir_s _v
    | MenhirState54 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (case : ((char * Ast.program) list)) = _v in
...
and _menhir_goto_instruction : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.program) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState27 | MenhirState39 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (_menhir_stack, _menhir_s, (instr : (Ast.program))) = _menhir_stack in
        let _v : (Ast.program) = 
# 35 "parser.mly"
                        ( instr )
# 273 "parser.ml"
    ...
    | MenhirState38 ->
        ...
        | END | EOF ->
            _menhir_reduce7 _menhir_env (Obj.magic _menhir_stack) MenhirState43
        | _ ->
            assert (not _menhir_env._menhir_error);
            _menhir_env._menhir_error <- true;
    ...
    | MenhirState49 ->
        ...
        | END | EOF ->
            _menhir_reduce5 _menhir_env (Obj.magic _menhir_stack) MenhirState50
        | _ ->
            assert (not _menhir_env._menhir_error);
            _menhir_env._menhir_error <- true;
  ...
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    | NEXT ->
        ...
        | OF ->
            ...
            | END | EOF ->
                _menhir_reduce3 _menhir_env (Obj.magic _menhir_stack) MenhirState54
            | _ ->
                assert (not _menhir_env._menhir_error);
                _menhir_env._menhir_error <- true;
    ...
    | STATE ->
        ...
        | OF ->
            ...
            | END | EOF ->
                _menhir_reduce5 _menhir_env (Obj.magic _menhir_stack) MenhirState47
            | _ ->
                assert (not _menhir_env._menhir_error);
                _menhir_env._menhir_error <- true;
    ...
    | TOP ->
        ...
        | OF ->
            ...
            | END | EOF ->
                _menhir_reduce7 _menhir_env (Obj.magic _menhir_stack) MenhirState36
            | _ ->
                assert (not _menhir_env._menhir_error);
                _menhir_env._menhir_error <- true;
...
and _menhir_goto_suitelettrenonvide : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.inputsymbols) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState4 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 666 "parser.ml"
         in
        _menhir_goto_suitelettrenonvide _menhir_env _menhir_stack _menhir_s _v
    | MenhirState2 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (s : (Ast.inputsymbols)) = _v in
...
# 824 "parser.ml"
                                ...
                                let _menhir_stack = Obj.magic _menhir_stack in
                                let _menhir_stack = Obj.magic _menhir_stack in
                                let (inistack : (Ast.initialstack)) = _v in
                                let ((((_menhir_stack, (i : (Ast.inputsymbols))), (stack : (Ast.inputsymbols))), (sta : (Ast.inputsymbols))), (inistate : (Ast.initialstate))) = _menhir_stack in
                                let _v : (Ast.declarations) = 
# 16 "parser.mly"
                                                                                                          (i, stack, sta, inistate, inistack)
# 833 "parser.ml"
                                 in
                                let _menhir_stack = (_menhir_stack, _v) in
                                let _menhir_stack = Obj.magic _menhir_stack in
